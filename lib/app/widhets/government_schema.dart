...
class GovernmentSchemeController extends GetxController {
  ...
  // Recipient options
  final recipientOptions = ['All Farmers', 'All Super Admins', 'Specific Region'];
  ...
  Future<void> sendScheme() async {
    ...
    try {
      // TODO: Implement API call to send scheme
      await Future.delayed(Duration(seconds: 2));
      
      UiUtils.showSuccessSnackbar(
        'Success',
        'Government scheme sent successfully to ${selectedRecipientType.value}',
      );
      ...
      UiUtils.showErrorSnackbar('Error', 'Failed to send scheme: $e');
    } finally {
...
class GovernmentSchemeWidget extends StatelessWidget {
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    maxLines: 8,
                    decoration: InputDecoration(
                      hintText: 'Enter detailed information about the scheme...',
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: Colors.grey[300]!),
                      ),
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: controller.isSending.value ? null : controller.sendScheme,
  ...
  Widget _buildFileCard(AttachedFile file, int index, GovernmentSchemeController controller) {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              file.type == AttachmentType.pdf ? Icons.picture_as_pdf : Icons.image,
              color: file.type == AttachmentType.pdf ? Colors.red : Color(0xFF7BB53B),
              size: 24,
            ),
          ),
          SizedBox(width: 12),
